...
Uçuş Zaman Çizelgesi ETA/ETD değerlerini, bunlar yoksa STA/STD değerlerini kullanır. Firma ve uçak tipi süre kuralı bulunmazsa Arrival için 40, Departure için 60 dakikalık global varsayılan uygulanır. Çizelgede firma gruplaması yerine operasyon memurları sabit sol eksende yer alır; çakışan uçuşlar aynı memur satırında düzenli alt şeritlere ayrılır. Uçuş bilgileri, atama ve izin verilen admin durum geçişleri sayfadan ayrılmadan sağ panelden yönetilebilir. Admin süreleri aynı sayfadan yönetir; supervisor yalnız ICAO kapsamındaki uçuşları salt okunur olarak görür.
