...
Her uçuşta yalnızca bir aktif sorumlu bulunur. Sorumlu kullanıcı operasyonu başlattığında durum `active` olur ve uçuş Genel Bakış ekranına girer; süreçlerin durumundan bağımsız olarak yalnızca aynı kullanıcı uçuşu tamamlayabilir ve süreçleri değiştirebilir. Manuel uçuş oluşturma yoktur; yeni uçuşlar yalnızca Uçuş Ekle ekranındaki Excel akışıyla kaydedilir. Admin tamamlanmış bir uçuşu planlanan, devam ediyor veya iptal durumuna geri alabilir; bu işlem süreç kayıtlarını değiştirmez. Uçuş silme işlemi kalıcıdır, yalnızca kısa audit kaydı bırakılır.
