...
Her uçuşta yalnızca bir aktif sorumlu bulunur. Sorumlu kullanıcı operasyonu başlattığında durum `active` olur ve uçuş Genel Bakış ekranına girer; zorunlu süreçler tamamlandıktan sonra aynı kullanıcı uçuşu tamamlar. Uçuş silme işlemi kalıcıdır, yalnızca kısa audit kaydı bırakılır.
