...
CREATE TABLE IF NOT EXISTS flights (
    ...
    status ENUM('scheduled', 'active', 'completed', 'cancelled', 'archived') NOT NULL DEFAULT 'scheduled',
    note TEXT NULL,
...
CREATE TABLE IF NOT EXISTS flight_assignments (
    ...
    UNIQUE KEY uq_flight_assignments_flight_user (flight_id, user_id),
...
INSERT INTO permissions (code, name, permission_group, description) VALUES
    ...
    ('flights.create', 'Uçuş Oluşturma', 'Uçuşlar', 'Manuel uçuş oluşturur'),
    ('flights.update', 'Uçuş Düzenleme', 'Uçuşlar', 'Uçuş bilgilerini değiştirir'),
    ('flights.cancel', 'Uçuş İptal/Arşiv', 'Uçuşlar', 'Uçuş durumunu iptal veya arşiv yapar'),
    ('flights.delete', 'Uçuşu Sistemden Kaldırma', 'Uçuşlar', 'Uçuşu listelerden kaldırır ve denetim geçmişini korur'),
    ('flights.assign', 'Uçuş Atama', 'Uçuşlar', 'Uçuşu aktif kullanıcılara atar'),
    ('flights.complete', 'Uçuş Tamamlama', 'Uçuşlar', 'Operasyon sürecini tamamlar'),
    ('imports.view', 'Import Geçmişini Görüntüleme', 'Excel Import', 'Excel importlarını görüntüler'),
    ('imports.stage', 'Excel Yükleme ve Düzeltme', 'Excel Import', 'Exceli önizleme alanına yükler ve düzeltir'),
    ('imports.commit', 'Excel Importunu Onaylama', 'Excel Import', 'Düzeltilmiş uçuşları SQL uçuş tablosuna aktarır'),
    ...
    ('processes.override', 'Süreç Düzeltme', 'Operasyon Süreçleri', 'Tamamlanmış süreç kayıtlarını sıfırlar veya düzeltir'),
